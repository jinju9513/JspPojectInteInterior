	...
	<ul class="links">
		...
		<li class="menu"><a>스토어</a>
			<ul class="more">
				...
				<li><a href="${pageContext.request.contextPath}/app/store/furniture.jsp">가구</a></li>
				<li><a href="${pageContext.request.contextPath}/app/store/bestSeller.jsp">베스트 상품</a></li>
			</ul></li>
		...
		<li class="menu"><a>고객센터</a>
			<ul class="more">
				<li><a href="${pageContext.request.contextPath}/app/customerService/notice.jsp">공지사항</a></li>
