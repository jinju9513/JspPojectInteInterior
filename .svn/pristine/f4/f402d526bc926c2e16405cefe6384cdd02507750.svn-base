	...
	<!-- Header -->
		...
		<div id="wrapper">
			...
			<div id="inquiry_container" style="height: auto;">
				<!-- inquiry_menu 시작 -->
				<div id="inquiry_menu">
					<a href="profile.jsp">회원정보 수정</a><a href="purchaseHistory.jsp">구매내역</a><a href="javascript:void(0);">장바구니</a><a href="myInquire.jsp">게시물 관리</a><a href="address.jsp">배송지 관리</a>
					<!-- inquiry_menu 끝 -->
				</div>
				<!-- div_table 시작 -->
				<div id="div_table">
					<table>
						...
						<thead>
							<tr>
								<th class="th-no1"><input type="checkbox" id="selectAll" name="selectAll" onclick="selectAll(this)"><label for="selectAll"></label>번호</th>
						...
						<tbody>
							...
							<tr>
								<td><input type="checkbox" class="select" id="select1" name="select" onclick="checkSelectAll()"><label for="select1"></label>1</td>
								<td>빈백</td>
								<td>960224</td>
							</tr>
							<tr>
								<td><input type="checkbox" class="select" id="select2" name="select" onclick="checkSelectAll()"><label for="select2"></label>2</td>
								<td>빈백</td>
								<td>960224</td>
							</tr>
							<tr>
								<td><input type="checkbox" class="select" id="select3" name="select" onclick="checkSelectAll()"><label for="select3"></label>3</td>
								<td>빈백</td>
								<td>960224</td>
							</tr>
							<tr>
								<td><input type="checkbox" class="select" id="select4" name="select" onclick="checkSelectAll()"><label for="select4"></label>4</td>
								<td>빈백</td>
								<td>960224</td>
							</tr>
						</tbody>
					...
					<div class="insertDeleteBtn">
						<input type="button" name="purchase" id="purchase" value="구매하기" style="float: right;">
