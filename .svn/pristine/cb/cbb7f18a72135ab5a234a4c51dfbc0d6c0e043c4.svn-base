...
<body>
   ...
   <div id="search_bar">
		<input style="line-height: 1px; border-top:0px; border-left:0px; border-right:0px; border-bottom-color: #8E8E8E;background: transparent; input:focus; outline:none;" placeholder="" type="search">
		<i class="fa fa-search" aria-hidden="true"></i>
	</div>
   <nav>
      <ul>
         <li><a href="${pageContext.request.contextPath}/app/member/signup.jsp">SignUp</a></li>
            <li><a href="${pageContext.request.contextPath}/app/member/login.jsp">Login</a></li>
