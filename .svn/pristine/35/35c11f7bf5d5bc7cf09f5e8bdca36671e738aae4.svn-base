	...
	<!-- Header -->
		...
		<div id="wrapper">
			...
			<div id="inquiry_container">
				<!-- inquiry_menu 시작 -->
				<div id="inquiry_menu">
					<a href="">상품문의</a><a href="">취소/변경문의</a><a href="">입고/배송문의</a><a
						href="">교환/반품문의</a><a href="">기타문의</a>
					<!-- inquiry_menu 끝 -->
				</div>
				<!-- div_table 시작 -->
				<div id="div_table">
					...
					<table>
						<tr align="center" valign="middle">
							<td>
							<c:if test="${nowPage > 1}">
								<a href="${pageContext.request.contextPath}/customerService/CS_BoardListOk.bo?page=${nowPage-1}">&lt;</a>
							</c:if>
