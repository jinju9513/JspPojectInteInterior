			...
			<div id="inquiry_container">
				...
				<div id="div_table">
					<select id="inqSelect" name="select" onchange="if(this.value) location.href=(this.value)">
						...
						<option value="myInquire.jsp" id="inq">문의내역&nbsp;&nbsp;</option>
						<option value="javascript:void(0);" id="cos">상담내역&nbsp;&nbsp;</option>
					</select>
					...
					<table>
						...
						<tbody>
							...
							<tr>
								<td colspan="5" align="center">상담내역이 없습니다.</td>
							</tr>
