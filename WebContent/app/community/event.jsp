			...
			<!-- Main -->
				...
				<%-- 		<table>
						<tr align="center" valign="middle">
							<td>
							<c:if test="${nowPage > 1}">
								<a href="${pageContext.request.contextPath}/community/EventList.bo?page=${nowPage-1}">&lt;</a>
							</c:if>
							...
							<c:forEach var="i" begin="${startPage}" end="${endPage}">
								<c:choose>
									...
									<c:otherwise>
										<a href="${pageContext.request.contextPath}/community/EventList.bo?page=${i}"><c:out value="${i}"/></a>
									</c:otherwise>
								</c:choose>
							</c:forEach>
