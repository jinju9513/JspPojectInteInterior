					...
					<form method="post"
						...
						<div class="row gtr-uniform">
							...
							<div class="col-12">
								...
								<label>ID<span
									style="font-size: 10px; font-weight: 100;"></span>
								</label><span id="idCheck_text" style="font-size: 0.7em;"></span> <input
							...
							<p>
								<a
									href="${pageContext.request.contextPath}/app/member/login.jsp"><strong>already
