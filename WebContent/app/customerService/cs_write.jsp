				...
				<table border="1">
					...
					<tbody class="">
						...
						<tr>
							...
							<td>
								<input id="board_file4" name="board_file4" type="file"> 
								<input type="button" onclick="cancelFile('board_file4')" value="첨부 삭제">
							</td>
						</tr>
						<tr>
							<th scope="row">첨부파일5</th>
							<td>
								<input name="board_file5" type="file">
								<input type="button" onclick="cancelFile('board_file5')" value="첨부 삭제">
							</td>
						</tr>
					</tbody>
						<tr>
